...
def dict_denester(
    ...
    e.g. {'a': 1, 'b': {'c': 1, 'd': {'e': [1, 2, 3]}}}
    becomes: {'a': 1, 'b-c': 1, 'b-d-e-0': 1, 'b-d-e-1': 2, 'b-d-e-2': 3}

    why name[1:]? -> skip initial - 
    """
...
def find_item(d: dict[Any, Any],  key_to_match: str) -> str:
    ...
    return the value belonging to that key that is the least nested
